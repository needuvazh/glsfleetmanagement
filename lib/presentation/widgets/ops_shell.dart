    ...
    final groups = [
      ...
      _MenuGroup(
        ...
        const [
          ...
          _OpsMenuItem('Vehicle Types', Icons.directions_car_filled_outlined, route: RoutePaths.vehicleTypes),
          _OpsMenuItem('Vendor', Icons.store_outlined, route: RoutePaths.vendorMaster),
          _OpsMenuItem('Location', Icons.location_on_outlined, route: RoutePaths.locationMaster),
